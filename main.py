...
connector.execute(
"CREATE TABLE IF NOT EXISTS DİS_KONTROL (STUDENT_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NAM0 EMAIL TEXT, PHONE_NO TEXT, GENDER TEXT, DOB TEXT, STREAM TEXT)"
)
